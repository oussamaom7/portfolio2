  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Pandas",
        image:
          "https://th.bing.com/th?q=Pandas+Python+Logo.svg&w=120&h=120&c=1&rs=1&qlt=90&cb=1&dpr=1.5&pid=InlineBlock&mkt=en-XA&cc=MA&setlang=fr&adlt=strict&t=1&mw=247",
      },
      {
        name: "Jupyter",
        image:
...
export const experiences = [
  ...
  },
  {
    ...
    desc: " I managed a team of three developers for an e-commerce project, focusing on the creation and deployment of advanced MERN stack web applications. I proactively addressed challenges to ensure the project's smooth progression and successful delivery. My experience with Agile/Scrum methodologies, using tools like Clickup and Asana, allowed for efficient project management and collaboration. On the frontend, I utilized JavaScript, React.js, Redux, HTML5, and CSS3 to create responsive designs, while on the backend, I worked with Node.js, Express.js, and developed RESTful APIs. Additionally, I used Socket.io for real-time communication and managed version control with Git and GitHub.I led a team of three developers on an e-commerce project, focusing on creating and deploying advanced MERN stack web applications. I ensured smooth project progress by proactively solving challenges and applying Agile/Scrum methodologies using tools like Clickup and Asana. On the frontend, I worked with JavaScript, React.js, Redux, HTML5, and CSS3, while on the backend, I used Node.js, Express.js, and developed RESTful APIs. I also utilized Socket.io for real-time communication and managed version control with Git and GitHub.",
    skills: [
      "ReactJS",
      "Redux",
      "NodeJs",
...
export const education = [
  ...
  {
    id: 1,
    img: "https://imgs.search.brave.com/F7R3FMMIqapAslLnUsbodyXE1f6ht6lMBOF0MSFyYb4/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9pY29u/YXBlLmNvbS93cC1j/b250ZW50L3BuZ19s/b2dvX3ZlY3Rvci91/bml2ZXJzaXRlLWhh/c3Nhbi0yLWRlLWNh/c2FibGFuY2EtbWFy/b2MtbG9nby5wbmc",
    school: "Université Hassan II, Casablnaca",
    date: "2020-2023",
    desc: "Gained a strong foundation in computer science and mathematics, with a focus on algorithms, data structures, programming, and problem-solving. Developed analytical thinking and practical coding skills essential for tackling complex computational challenges.",
